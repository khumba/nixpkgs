...
let
  ...
  badArch = throw "scilabBin5 requires i686-linux or x86_64-linux";
...
stdenv.mkDerivation rec {
  ...
  fixupPhase = ''
    ...
    fullLibPath="$fullLibPath:${jdk}/lib/openjdk/jre/lib/${javaArchitecture}"
    fullLibPath="$fullLibPath:${jdk}/lib/openjdk/jre/lib/${javaArchitecture}/server"
    fullLibPath="$fullLibPath:${jdk}/lib/openjdk/jre/lib/${javaArchitecture}/xawt"
